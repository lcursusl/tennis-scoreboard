    ...
    <div>
      ...
      <div class="form-container center">
        <form method="post" action="${pageContext.request.contextPath}/new-match">
          ...
          <input class="input-player" id="playerOne" name="player1" placeholder="Name" type="text" required>
          <label class="label-player" for="playerTwo">Player two</label>
          <input class="input-player" id="playerTwo" name="player2" placeholder="Name" type="text" required>
